		...
		dependencies = {
			{
				...
				config = function()
					...
					vim.keymap.set("n", "gr", ":Lspsaga finder ref<cr>")
					vim.keymap.set("n", "gi", ":Lspsaga finder imp<cr>")
					vim.keymap.set("n", "gd", ":Lspsaga goto_definition<cr>")
					vim.keymap.set("n", "<leader>lr", ":Lspsaga rename<cr>")
					vim.keymap.set("n", "<leader>lpr", ":Lspsaga lsp_rename ++project<cr>")
					vim.keymap.set({ "n", "v" }, "<leader>la", ":Lspsaga code_action<cr>")
				end,
				dependencies = {
